...
func init() {
	buildInfo := metrics.NewGaugeVec(
		&metrics.GaugeOpts{
			Name: "open_cluster_management_hoh_agent_build_info",
			Help: "A metric with a constant '1' value labeled by major, minor, git commit & git version from which Open Cluster Management Hub of Hubs Addon Controller was built.",
		},
